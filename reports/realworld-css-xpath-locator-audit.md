...
Generated: 2026-04-21T18:07:31.708Z

## Overlap Audit

- Current matched-surface rows: 45/57 (0.7895)
- Current family-distinct rows: 12/57 (0.2105)
- Refactored matched-surface rows: 21/57 (0.3684)
- Refactored family-distinct rows: 36/57 (0.6316)
...
| --- | --- | --- | --- | --- | --- | --- |
| nav.brandLink | class-token | class-context | matched-surface | class-token | text-normalized | family-distinct |
| nav.navbar | class-token | class-context | matched-surface | class-token | text-normalized | family-distinct |
...
| auth.submitButton | attribute-selector | attribute-predicate | matched-surface | attribute-selector | text-normalized | family-distinct |
| nav.globalFeedTab | attribute-selector | attribute-predicate | matched-surface | attribute-selector | text-normalized | family-distinct |
| home.firstReadMoreLink | scoped-structure | class-context | family-distinct | scoped-structure | class-context | family-distinct |
| comments.textarea | attribute-selector | accessibility-attribute-predicate | family-distinct | scoped-attribute-structure | accessibility-attribute-predicate | family-distinct |
| comments.submitButton | attribute-selector | attribute-predicate | matched-surface | scoped-attribute-structure | text-normalized | family-distinct |
| settings.bioInput | attribute-selector | attribute-predicate | matched-surface | attribute-selector | accessibility-attribute-predicate | family-distinct |
| settings.submitButton | attribute-selector | attribute-predicate | matched-surface | attribute-selector | text-normalized | family-distinct |
...
| article.title | class-token | class-context | matched-surface | class-token | text-normalized | family-distinct |
...
| comments.textarea | attribute-selector | attribute-predicate | matched-surface | attribute-selector | accessibility-attribute-predicate | family-distinct |
| comments.submitButton | attribute-selector | attribute-predicate | matched-surface | scoped-attribute-structure | text-normalized | family-distinct |
| settings.bioInput | attribute-selector | attribute-predicate | matched-surface | attribute-selector | accessibility-attribute-predicate | family-distinct |
| settings.submitButton | class-token | class-context | matched-surface | class-token | text-normalized | family-distinct |
| article.favoriteButton | accessibility-attribute | accessibility-attribute-predicate | matched-surface | accessibility-attribute | accessibility-attribute-predicate | matched-surface |
| home.previewDescription | scoped-structure | class-context | family-distinct | scoped-attribute-structure | accessibility-attribute-predicate | family-distinct |
| comments.deleteButton | accessibility-attribute | accessibility-attribute-predicate | matched-surface | accessibility-attribute | accessibility-attribute-predicate | matched-surface |
| article.title | class-token | class-context | matched-surface | class-token | text-normalized | family-distinct |
...
| comments.textarea | attribute-selector | accessibility-attribute-predicate | family-distinct | attribute-selector | accessibility-attribute-predicate | family-distinct |
| comments.submitButton | attribute-selector | attribute-predicate | matched-surface | scoped-attribute-structure | accessibility-attribute-predicate | family-distinct |
